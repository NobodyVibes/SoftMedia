import { Edit2, Trash2, Folder, ArrowUp, ArrowDown, RefreshCw } from 'lucide-react';
...
export function LibraryListTable({ libraries, onEdit, onDelete, onReorder, onScan }: LibraryListTableProps) {
