...
/// <summary>
/// Static UPnP XML: the MediaServer device description (with {friendlyName}/{udn} substituted)
/// and the two service SCPDs. Service URLs are relative — the TV resolves them against the
/// description URL's host, so no base URL needs injecting here.
/// </summary>
public static class DlnaDescriptions
{
...
<root xmlns="urn:schemas-upnp-org:device-1-0" xmlns:dlna="urn:schemas-dlna-org:device-1-0">
  ...
  <device>
    ...
    <friendlyName>{System.Security.SecurityElement.Escape(friendlyName)}</friendlyName>
    <manufacturer>SoftMedia</manufacturer>
    <modelName>SoftMedia</modelName>
    <modelDescription>SoftMedia DLNA Media Server</modelDescription>
    ...
    <serviceList>
      <service>
        ...
        <SCPDURL>/dlna/cd/scpd.xml</SCPDURL>
